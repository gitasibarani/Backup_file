...
destination_folder = "D:\\Devops\\hasil_backup" 

# Fungsi untuk menjalankan backup dan mengirim notifikasi
def run_backup():
    try:
...
# Menjadwalkan backup setiap 10 menit
schedule.every(10).minutes.do(run_backup)

for i in range(24):
    schedule.run_pending()
    time.sleep(5)  # Tunggu 1 detik sebelum mengecek jadwal lagi

logger.info("Backup process finished after 24 iterations.")